            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="index.html">
                  ...
                  <!--<p><strong>WINGMAN</strong> <span>Always with you</span></p> -->

                </a>
                <!-- img based logo -->
                <a href="index.html"><img src="img/logo.jpg" width="20%" height="10%" alt="logo img"></a> 
              </div>
              <!-- / logo  -->
               <!-- cart box -->
        ...
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              ...
              <div class="seq-title">
                <span data-seq>Save Up to 75% Off</span>                
                <h2 data-seq>Italian Cuisines</h2>                
                <p data-seq>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus, illum.</p>
                <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn">SHOP NOW</a>
              </div>
            </li>
            ...
            <li>
              ...
              <div class="seq-title">
                <span data-seq>Save Up to 75% Off</span>                
                <h2 data-seq>Chinese Cuisines</h2>                
                <p data-seq>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus, illum.</p>
                <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn">SHOP NOW</a>
              </div>
            </li>
